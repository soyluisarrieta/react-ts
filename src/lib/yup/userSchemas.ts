...
export const avatar = yup
  .mixed<File>()
  .test('is-valid-avatar-type', 'Tipo de archivo de avatar no válido', (value) => isSupportedFileType(value?.name as string, 'IMAGES'))
  .test('is-valid-size', `El tamaño máximo permitido es ${FILE_CONFIG.MAX_SIZE / 1024} KB`, (value) => value && value.size <= FILE_CONFIG.MAX_SIZE)
